...
//2922784/1856388/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "DMP3007LSS-13" (originalName "DMP3007LSS-13")
	...
	(compDef "DMP3007LSS-13" (originalName "DMP3007LSS-13") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "DMP3007LSS-13"))
		...
		(attr "Mouser Part Number" "621-DMP3007LSS-13")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/DMP3007LSS-13?qs=qSfuJ%252Bfl%2Fd6BWzce%2FirNpQ%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "DMP3007LSS-13")
		(attr "Description" "MOSFET MOSFET BVDSS: 8V-24V")
		(attr "<Hyperlink>" "https://www.diodes.com//assets/Datasheets/DMP3007LSS.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "DMP3007LSS-13.stp")
